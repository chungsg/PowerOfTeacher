...
type
  ...
  private
    ...
    Fswm_DeleteYoutubeCommand: TDBXCommand;
  ...
  public
    ...
    function swm_DeleteYoutube(userid: string; lesson: string; title: string; url: string): Boolean;
...
function TServerMethods1Client.swm_DeleteYoutube(userid: string; lesson: string; title: string; url: string): Boolean;
begin
  if Fswm_DeleteYoutubeCommand = nil then
  begin
    Fswm_DeleteYoutubeCommand := FDBXConnection.CreateCommand;
    Fswm_DeleteYoutubeCommand.CommandType := TDBXCommandTypes.DSServerMethod;
    Fswm_DeleteYoutubeCommand.Text := 'TServerMethods1.swm_DeleteYoutube';
    Fswm_DeleteYoutubeCommand.Prepare;
  end;
  Fswm_DeleteYoutubeCommand.Parameters[0].Value.SetWideString(userid);
  Fswm_DeleteYoutubeCommand.Parameters[1].Value.SetWideString(lesson);
  Fswm_DeleteYoutubeCommand.Parameters[2].Value.SetWideString(title);
  Fswm_DeleteYoutubeCommand.Parameters[3].Value.SetWideString(url);
  Fswm_DeleteYoutubeCommand.ExecuteUpdate;
  Result := Fswm_DeleteYoutubeCommand.Parameters[4].Value.GetBoolean;
end;
...
begin
  ...
  Fswm_DeleteYoutubeCommand.DisposeOf;
